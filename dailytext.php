<?php
  ...
  $pretext = convertLinks(mb_convert_encoding(removeTags($dom->find('.themeScrp',0)), 'UTF-8', 'HTML-ENTITIES'), $language[0]); //get pretext
  $bodytext = convertLinks(mb_convert_encoding(removeTags($dom->find('.sb',0)), 'UTF-8', 'HTML-ENTITIES'), $language[0]); //get bodytext
